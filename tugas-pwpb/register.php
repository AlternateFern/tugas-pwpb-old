...
if( isset($_POST['submit']) ){
        ...
        if(!empty(trim($name)) && !empty(trim($username)) && !empty(trim($email)) && !empty(trim($notelp)) && !empty(trim($password)) && !empty(trim($repass))){
            ...
            if($password == $repass){
                ...
                if( cek_nama($name,$con) == 0 ){
                    ...
                    $query = "INSERT INTO users (name, username, email, no_hp, password ) VALUES ('$name','$username','$email','$notelp','$pass')";
            ...
            <section class="col-12 col-sm-6 col-md-4">
                <form class="form-container" action="register.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="notelp" name="notelp" placeholder="Masukkan nomor telpon">
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" name="submit" class="btn btn-block" style="background-color:maroon;color:white;font-weight:bold;">Register</button>
